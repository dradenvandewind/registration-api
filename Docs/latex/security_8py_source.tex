...
\label{security_8py_source}\index{core/security.py@{core/security.py}}
...
\DoxyCodeLine{00062\ }
\DoxyCodeLine{00063\ \textcolor{keyword}{def\ }generate\_activation\_code(length:\ int\ =\ 4)\ -\/>\ str:}
...
\DoxyCodeLine{00068\ \textcolor{stringliteral}{\ \ \ \ \ \ \ \ length:\ Code\ length\ (default:\ 4)}}
