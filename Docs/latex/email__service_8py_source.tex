...
\label{email__service_8py_source}\index{services/email\_service.py@{services/email\_service.py}}
...
\DoxyCodeLine{00026\ \ \ \ \ \ \ \ \ \ \ \ \ print(f\textcolor{stringliteral}{"{}📧\ Sending\ activation\ code\ \{code\}\ to\ \{email\}"{}})}
\DoxyCodeLine{00027\ \ \ \ \ \ \ \ \ \ \ \ \ }
