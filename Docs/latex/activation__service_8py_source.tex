...
\label{activation__service_8py_source}\index{services/activation\_service.py@{services/activation\_service.py}}
...
\DoxyCodeLine{00034\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{\#\ Generate\ a\ 4-\/character\ code\ (to\ match\ the\ database)}}
\DoxyCodeLine{00035\ \ \ \ \ \ \ \ \ \ \ \ \ code\ =\ generate\_activation\_code(length=4)\ \ \textcolor{comment}{\#\ Force\ length\ to\ 4}}
