...
\label{api_2v1_2endpoints_2activation_8py_source}\index{api/v1/endpoints/activation.py@{api/v1/endpoints/activation.py}}
...
\DoxyCodeLine{00020\ \textcolor{stringliteral}{\ \ \ \ Activate\ user\ account\ with\ 4-\/digit\ code}}
